...
if __name__ == "__main__" :
	...
	label1 = Label(root, text = "Principal Amount(Rs) : ",fg = 'black', bg = 'pink')

	label2 = Label(root, text = "Rate(%) : ",fg = 'black', bg = 'pink')
		
	label3 = Label(root, text = "Time(years) : ",fg = 'black', bg = 'pink')

	label4 = Label(root, text = "Compound Interest : ",fg = 'black', bg = 'pink')
	...
	button1 = Button(root, text = "Submit", bg = "orange",fg = "black", command = calculate_ci)
					
	button2 = Button(root, text = "Clear", bg = "orange",fg = "black", command = clear_all)
